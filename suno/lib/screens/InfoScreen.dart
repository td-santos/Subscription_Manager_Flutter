          ...
          child: Container(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    padding: EdgeInsets.only(left: width * 0.05,right: width * 0.05,top: 20,bottom: 5),
                    child: Text(
                      "Nome",
                      style:
                          TextStyle(fontSize: width * 0.03, color: Colors.blue),
                    ),
                  ),
                  Padding(
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: width * 0.05,right: width * 0.05,top: 10,bottom: 5),
                    child: Text(
                      "Versão do App",
                  ...
                  Divider(color: Colors.grey),
                  Padding(
                    padding: EdgeInsets.only(left: width * 0.05,right: width * 0.05,bottom: 10,top: 60),
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border.all(
                                width: 1, color: Colors.deepPurple[300]),
